...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { attempts: @rsvp.attempts, form_id: @rsvp.form_id, last_attempt: @rsvp.last_attempt, subscriber_id: @rsvp.subscriber_id, success: @rsvp.success }
    end
  ...
  test "should update rsvp" do
    patch :update, id: @rsvp, rsvp: { attempts: @rsvp.attempts, form_id: @rsvp.form_id, last_attempt: @rsvp.last_attempt, subscriber_id: @rsvp.subscriber_id, success: @rsvp.success }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
