...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { code: @coupon.code, description: @coupon.description, expiration_date: @coupon.expiration_date }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { code: @coupon.code, description: @coupon.description, expiration_date: @coupon.expiration_date }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
