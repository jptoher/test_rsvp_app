class SubscribersController < ApplicationController
  ...
  private
    ...
    def subscriber_params
      params.require(:subscriber).permit(:first_name, :last_name, :address1, :address2, :city, :state, :zip, :email, :fake_email, :affiliation, :phone, :coupon_id, :type_id, :date_joined)
    end
end
